...
<%if ((request.getAttribute("retro"))!=null) { %>
    ...
    <table class="table">
      ...
      <% for (Valor_especialidad valor_especialidad : lv) { %>
      
        <tr>
        	<td><%= valor_especialidad.getEspecialidad().getCodigo_esp() %></td>
          	<td><%= valor_especialidad.getEspecialidad().getNombre() %></td>
          	<td><%= valor_especialidad.getValor() %></td>
          	
          
          <td>
            <form action="EspecialidadesServlet" method="POST">
              <input type="hidden" name="id2" value="<%= valor_especialidad.getEspecialidad().getCodigo_esp() %>">
